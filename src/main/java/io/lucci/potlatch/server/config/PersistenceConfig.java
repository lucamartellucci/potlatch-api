...
@ComponentScan({ "io.lucci.potlatch.server.persistence" })
@EnableJpaRepositories(basePackages = "io.lucci.potlatch.server.persistence.repository")
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "io.lucci.potlatch.server.persistence.model" });
